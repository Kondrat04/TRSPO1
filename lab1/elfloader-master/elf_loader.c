...
int run_elf_module(struct elf_module *m, const char *func, int argc, char** argv)
{
    ...
    functions[8]=strcmp;
    functions[9]=memset;
    functions[10]=strncpy;
    functions[11]=mmap;
    functions[12]=realloc;
    functions[13]=memmove;
    functions[14]=frexp;
    functions[15]=modf;
    functions[16]=pow;
    functions[17]=fputc;
    ...
    functions[31]=fclose;
    functions[32]=close;
    functions[33]=strerror;
    functions[34]=remove;
    functions[35]=fprintf;
    functions[36]=read;
    functions[37]=longjmp;
    functions[38]=_setjmp;
    functions[39]=abort;
    functions[40]=printf;
    functions[41]=stpcpy;
    functions[42]=sprintf;
    functions[43]=open;
    functions[44]=__fxstat;
    functions[45]=gmtime;
    functions[46]=ferror;
