...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -fPIC -I/usr/local/include -I/usr/local/include/libpng16 -I/usr/local/include -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS           :=  -L/usr/local/lib -lz -L/usr/local/lib -lpng16 -lz
